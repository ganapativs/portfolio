---
title: "Abortable fetch using the AbortController"
date: '2020-02-08'
...
**TLDR:** `AbortController` is used to abort a fetch request. [Check out the demo](#demo).
...
![Abort controller in devtool](./abort-controller-devtool-eval.png)
...
![Aborted fetch request in devtool](./fetch-devtool-cancelled.png)
...
- [https://github.com/whatwg/fetch/issues/27#issuecomment-267483591](https://github.com/whatwg/fetch/issues/27#issuecomment-267483591)
